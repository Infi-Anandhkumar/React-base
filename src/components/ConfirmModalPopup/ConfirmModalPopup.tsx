      ...
      <div className="ConfirmModalPopup" data-testid="ConfirmModalPopup">
        <Modal
          ...
          closeIcon={
            ...
            //   <Text className="Infi-09_CloseIcon cls-close-modal-icon"></Text>
            // ) : (
              false
            // )
          }
        ...
        >
          ...
          {props?.header && (
            <Row className="cls-modal mb-5" justify="center">
            ...
            <Row className="cls-modal mb-5" justify="center">
              <Col xs={24} xl={24}>
                {props?.list?.map((list: any) => (
                  <Text className="f-reg fs-16 text-center cls-grey pb-8">{list}</Text>
                ))}
              </Col>
            </Row> : <></>
          }
          <Row className="cls-modal" justify="center">
            {props.description &&
              <Col xs={24} xl={22} className="fs-18 mb-20 cls-modal-body text-center">
            ...
            {props?.primaryBtn?.text && (
              <Col xs={11} xl={8} className="mt-20 cls-btn">
                <Button
            ...
            <Col xs={11} xl={8} className="mt-20 cls-btn" offset={1}>
              <Button
                type="primary"
                block
                className={`cls-modal-btn f-med ${(props.modalName === "declineOffer" || props.modalName === "cancel") && confirmBtn ? "disabled no-events" : ""} ${isSmallScreen ? "cls-primary-btn-inverted" : ""}`}
                size="large"
                onClick={handleOk}
